 ...
 * @param {string} attrPropertyName
 * @param {string} targetName
 * @param {NodePath[]} elements
 * @return {Node}
 */
function generateMappedAttributeCode(attrPropertyName, targetName, elements) {
...
module.exports = declare((api, options) => {
  ...
  const attrPropertyName = options?.attrPropertyName || '__attributes__';
